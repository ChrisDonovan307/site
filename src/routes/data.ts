    ...
    items: [
      {
        title: 'AgConnect',
        content:
          '<p><b>AgConnect</b> is a UVM Extension platform that will facilitate on-farm research trials by connecting farmers with researchers, help manage experiments, and provide automated analyses and reports. The platform is being developed with Ruby on Rails and is expected to launch in the spring of 2026.</p>',
        image: 'agconnect.png',
