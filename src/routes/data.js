		...
		items: [
			{
				...
				image: '<img src="assets/images/smdata.png" alt="alt-text" style="border: none !important;">',
			...
			},
			{
				...
				image: '<img src="assets/images/smdocs.png" alt="alt-text">',
			...
			},
			{
				...
				image: '<img src="assets/images/smex_slim.png" alt="alt-text">',
		...
		items: [
			{
				...
				image: '<img src="assets/images/agconnect.png" alt="alt-text">',
		...
		items: [
			{
				...
				image: '<img src="assets/images/rebl_package.png" alt="alt-text">',
			...
			},
			{
				...
				image: '<img src="assets/images/reblcalc.png" alt="alt-text">',
		...
		items: [
			{
				...
				image: '<img src="assets/images/grade_analysis_app.png" alt="alt-text">',
...
export const socials = [
	...
	},
	{
        ...
        // image: '<img src="assets/images/fsri_spirit_mark.png" class="spirit">'
	},
	{
